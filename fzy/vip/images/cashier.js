(function () {
    ...
    LIB.cookie = {
        ...
        set: function (key, value, opt) {
            var _date = new Date(),
                _domain = opt.domain || "http://imgcache.qq.com/bossweb/ipay/js/api/pay.qq.com",
                _path = opt.path || "/",
    ...
    //var aL = document.domain == (aP.INFO.platform == "pengyou" ? "http://imgcache.qq.com/bossweb/ipay/js/api/pengyou.com": "http://imgcache.qq.com/bossweb/ipay/js/api/qq.com");
    ...
    dialogAllCSS.push(".cash_dialog_header button{background-color:transparent;background-image:url('//", INFO.isp, "http://imgcache.qq.com/bossweb/ipay/js/api/qzonestyle.gtimg.cn/open/fusion/img/sprite.png?max_age=31104000&v=3');background-repeat:no-repeat;background-position:10px 10px;float:right;width:29px;height:28px;margin-right:5px;line-height:100px;border:0 none;cursor:pointer;font-size:0;}");
    ...
    dialogAllCSS.push(".cash_dialog_confirm_icon{background-image:url('//", INFO.isp, "http://imgcache.qq.com/bossweb/ipay/js/api/qzonestyle.gtimg.cn/open/fusion/img/sprite.png?max_age=31104000&v=3');background-repeat:no-repeat;width:25px;height:24px;font-size:0;line-height:100px;overflow:hidden;left:0;top:-2px;position:absolute;}");
    ...
    dialogAllCSS.push(".cash_dialog_confirm_icon_alt i{background-image:url('//", INFO.isp, "http://imgcache.qq.com/bossweb/ipay/js/api/qzonestyle.gtimg.cn/open/fusion/img/sprite.png?max_age=31104000&v=3');background-repeat:no-repeat;width:15px;height:15px;display:block;position:absolute;}");
    ...
    /*if (/(?:^|\.)qq\.com$/.test(location.hostname)) {
     document.domain != "http://imgcache.qq.com/bossweb/ipay/js/api/qq.com" && (document.domain = "http://imgcache.qq.com/bossweb/ipay/js/api/qq.com")
     } else if (/(?:^|\.)pengyou\.com$/.test(location.hostname)) {
     document.domain != "http://imgcache.qq.com/bossweb/ipay/js/api/pengyou.com" && (document.domain = "http://imgcache.qq.com/bossweb/ipay/js/api/pengyou.com")
     }*/
    ...
    thisAPI.dialog.buy = function (opts) {
        ...
        if(useWebpay&&_src_name == "iframe"){
            ...
            LIB.logData({
                36: location.href,//调用业务网址
                21: 'http://imgcache.qq.com/bossweb/ipay/js/api/pay.cashier.buy',//接口名
                50: navigator.userAgent,//userAgent
                19: opts.codes,
                8: opts
            });
        ...
        if (_src_name === 'iframe') {
            ...
            }, 'http://imgcache.qq.com/bossweb/ipay/js/api/dialog.buy');
    ...
    thisAPI.gray = function (opts) {
        ...
        thisAPI.LIB.report(['http://upayportal.qq.com/cgi-bin/action_report.fcg?ch=self',
            'uin=' + _uin.substr(1) * 1,
        ...
        LIB.logData({
            36: location.href,//调用业务网址
            3: _uin,//用户uin
            21:'http://imgcache.qq.com/bossweb/ipay/js/api/pay.cashier.gray',//接口名
            50:navigator.userAgent,//userAgent
            19:opts.codes,
            8:opts
        });
